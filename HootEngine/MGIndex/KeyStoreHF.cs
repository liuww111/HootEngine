            ...
            lock (_lock)
            {
                ...
                if (_keys.Get(key, out alloc))
                {
                    ...
                    if (ab.deleteKey == false)
                    {
                        ...
                        //return fastBinaryJSON.BJSON.ToObject(data);//fastBinaryJSON
                        return _bson.DeserializeObject<object>(data);
                    }
                }
            }
        ...
        public int Increment(string key, int amount)
        {
            ...
            lock (_lock)
            {
                ...
                if (ab.deleteKey == false)
                {
                    ...
                    //obj = fastBinaryJSON.BJSON.ToObject(data);//fastBinaryJSON
                    obj = _bson.DeserializeObject<object>(data);
